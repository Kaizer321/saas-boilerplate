    ...
    return (
        <div className="space-y-6">
            ...
            <div className="text-center">
                ...
                <p className="mt-2 text-sm text-slate-600">Get started with your booking platform</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-slate-200/60 p-8">
                ...
                <button
                    ...
                    type="button"
                    className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-slate-200 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors"
                >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                                minLength={6}
                                className="w-full px-3.5 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors pr-10"
                            />
                            <button
                                type="button"
